            ...
            <div class="card-body p-4">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <div class="h3 mb-0 fw-bold">$40,000</div>
            ...
            <div class="card-body p-4">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <div class="h3 mb-0 fw-bold">215</div>
                        <div class="small text-success mt-2">
                            <i class="bi bi-arrow-up"></i> 8.3% increase
                        </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body py-4">
                <div class="row g-3">
                    <div class="col-lg-3 col-md-6">
                        <a href="#" class="btn btn-primary w-100 d-flex align-items-center justify-content-center py-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="#" class="btn btn-info w-100 d-flex align-items-center justify-content-center py-3 text-white">
                            <i class="bi bi-box me-2"></i> Manage Inventory
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <a href="#" class="btn btn-warning w-100 d-flex align-items-center justify-content-center py-3">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="px-4 py-3"><a href="#" class="btn btn-sm btn-outline-primary"><i class="bi bi-eye"></i></a></td>
                            </tr>
                            <tr>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr class="table-danger">
                                ...
                                <td class="px-4 py-3">
                                    <button class="btn btn-sm btn-outline-primary me-1"><i class="bi bi-plus-circle"></i> Restock</button>
                                </td>
                            </tr>
